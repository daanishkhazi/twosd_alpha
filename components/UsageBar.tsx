...
const UsageBar: React.FC = () => {
  ...
  return (
    <div className="items-center bg-white w-full sm:w-4/6 mt-10 px-5 py-3 border-4 border-slate-400 justify-center shadow-2xl rounded-xl">
      <div className=" w-full justify-center">
        ...
        <div className="flex justify-center items-center italic">
          <div className="flex flex-col text-[0.6rem] md:text-xs lg:text-sm pr-4">
            Want to ask more questions?
          </div>
          <Link href="/settings" className="flex w-1/4">
            <button className="hover:scale-105 text-xs sm:text-sm transition ease-in-out delay-50 px-1 py-1 rounded-xl text-black w-full bg-teal-400 border-0 justify-center min-w-max">
              Upgrade
            </button>
          </Link>
        </div>
