    ...
    <Layout>
      <div className="flex flex-col items-center justify-center min-h-screen py-12">
        <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
          ...
          <div className="mt-3 text-xl text-left w-1/2 space-y-2">
            <p>
              Laera, Inc. operates the www.laera.xyz website, which provides the
              SERVICE.
            </p>
            ...
            <p>
              ...
              our Terms and Conditions, which is accessible at www.laera.xyz,
            ...
            <h2 className="text-3xl font-bold">Log Data</h2>
            ...
            <p>
              ...
              browser version, pages of our Service that you visit, the time and
