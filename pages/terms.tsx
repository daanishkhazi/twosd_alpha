        ...
        <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
          ...
          <div className="mt-3 text-2xl text-left w-1/2">
            ...
            <p className="text-xs">
              ...
              and Laera, Inc. Company,&quot; &quot;we&quot; &quot;us&quot; or
              “our”, concerning your access to and use of the{" "}
              <Link href="http://www.laera.xyz">http://www.laera.xyz</Link>{" "}
              website as well as any other media form, media channel, mobile
              website or mobile application related, linked, or otherwise
              connected thereto (collectively, the “Site”). We are registered in
              Washington, United States and have our registered office at 27508
              Southeast 30th Street, Sammamish, WA 98075. You agree that by
              ...
              subjected to such laws, you may not use this Site. You may not use
              the Site in a way that would violate the Gramm-Leach-Bliley Act
              (GLBA). All users who are minors in the jurisdiction in which they
            ...
            <p className="text-xs">
              ...
              features, functions, operation, or maintenance of the Site. Engage
              ...
              data gathering and extraction tools. Delete the copyright or other
              proprietary rights notice from any Content. Attempt to impersonate
              another user or person or use the username of another user. Upload
              ...
              networks or services connected to the Site. Harass, annoy,
              ...
              Site, or any portion of the Site. Copy or adapt the Site&apos;s
              ...
              using or launching any unauthorized script or other software. Use
              a buying agent or purchasing agent to make purchases on the Site.
              Make any unauthorized use of the Site, including collecting
              usernames and/or email addresses of users by electronic or other
              means for the purpose of sending unsolicited email, or creating
              user accounts by automated means or under false pretenses. Use the
              ...
              goods and services. Sell or otherwise transfer your profile.
            </p>
            ...
            <p className="text-xs">
              ...
              Policy:{" "}
              <Link href="https://www.laera.xyz/privacy">
                https://www.laera.xyz/privacy
              </Link>
            ...
            <p className="text-xs">
              ...
              the State of Washington, without regard to its conflict of law
              principles.
            </p>
            ...
            <p className="text-xs">
              ...
              King County, Washington, and the Parties hereby consent to, and
              ...
              these Terms of Use. In no event shall any claim, action, or
              proceeding brought by either Party related in any way to the Site
              be commenced more than one (1) years after the cause of action
              arose.
            </p>
